...
public class Task3 {
    ...
    public static int task3D_recursive(Node head) {
        ...
        if (head!=null) {
          sum += head.elem;
          return sum + task3D_recursive(head.next);}
        return sum;
    }
    ...
    public static int task3F_recursive(Node head) {
        return oddsm(head) - evenpr(head);
    }
    
    public static int evenpr(Node head) {
        if (head!=null) {
          if (head.elem%2 == 0) {
            return head.elem * evenpr(head.next);}
          else{
            return 1 * evenpr(head.next);}}
        else {
          return 1;}
    }
    
    public static int oddsm(Node head) {
        if (head!=null) {
          if (head.elem%2 != 0) {
            return head.elem + oddsm(head.next);}
          else{
            return 0 + oddsm(head.next);}}
        else {
          return 0;}
    }
